...
public class ESP8266UDPServer {
	...
	public void send(String data, AppUser appUser) {
		this.send(data, appUser.getAddress(), appUser.getPort());
	}

	public void send(String data, List<AppUser> appUsers){
	...
	public ESP8266UDPServerAppObservable register(String appId, List<UDPHandleProcess> handleProcessList) {
		this.register(appId);
