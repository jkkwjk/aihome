...
export default {
  ...
  solar2lunar(y, m, d) { // 参数区间1900.1.31~2100.12.31
    ...
    return {
      lYear: year, lMonth: month, lDay: day, Animal: this.getAnimal(year), IMonthCn: (isLeap ? '\u95f0' : '') + this.toChinaMonth(month), IDayCn: this.toChinaDay(day), cYear: y, cMonth: m, cDay: d, gzYear: gzY, gzMonth: gzM, gzDay: gzD, isToday, isLeap, nWeek, ncWeek: `\u661f\u671f${cWeek}`, isTerm, Term, astro,
    };
  },
